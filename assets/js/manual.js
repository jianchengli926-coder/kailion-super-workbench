...
(function () {
  ...
  const FAQS = [
    ...
    ['不会写代码、不会搭流程，能用吗？',
     '完全可以。两个零门槛入口：① 直接对小锴助手说需求，它会自动搭建工作流；② 工作流库里有 20 套现成模板，加载后改改参数就能跑。'],
    ['工作流乱了想重来怎么办？',
  ...
  const GUIDE = [
    ...
    { icon: '🤖', title: '小锴助手', titleEn: 'XiaoKai Assistant', desc: '右下角悬浮面板，用自然语言下达指令，它会自动在画布上搭工作流。' }
  ];
      ...
      <div class="manual-wrap">
        ...
        <section id="sec-start" class="manual-section">
          ...
          <div class="manual-steps">
            ...
            <div class="mstep"><div class="mstep-num">4</div><div class="mstep-body"><b>运行</b><p>点顶部「运行」，小锴助手会按连线顺序调度节点并产出结果。</p></div></div>
          </div>
        </section>
