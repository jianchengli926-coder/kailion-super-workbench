...
window.NODE_DATA = [
  ...
  },
  {
    ...
    nodes: [
      ...
      ['智能搜索', 'smartSearchNode', '7大搜索引擎+AI总结，自动选择最佳引擎，支持时间范围筛选', 1,
       'Smart Search', '7 search engines + AI summary, auto-select best engine, time filter'],
      ['自动路由', 'autoRouterNode', '自动识别任务类型，按最快/最省/最优策略选择最佳AI供应商', 1,
       'Auto Router', 'Auto-detect task type, select best AI provider by fastest/cheapest/quality'],
  ...
  {
    cat: '锴利专线', catEn: 'KaiLion Exclusive', icon: '🦁', color: '#C9A227',
    nodes: [
      ['产品图精修', 'klProductShotNode', '刀具/剪刀/厨具产品图精修：自动去背、统一布光、金属质感还原', 1,
       'Product Photo Retouch', 'Knife/scissor/kitchenware product retouch: auto cutout, unified lighting, metal texture restoration'],
      ['规格参数表', 'klSpecSheetNode', '把口头参数整理成中英双语规格表并存入知识库', 1,
       'Spec Sheet', 'Turn verbal specs into a bilingual (CN/EN) specification table saved to the knowledge base'],
      ['询盘邮件生成', 'klInquiryReplyNode', '粘贴买家询盘，自动识别买家类型并生成英文 B2B 回复', 1,
...
window.BRAND = {
  ...
  product: '锴利超级AI工作台',
  productEn: 'KaiLi Super AI Workbench',
  shortName: '锴利',
  assistant: '小锴助手',
  assistantEn: 'XiaoKai Assistant',
  logo: 'assets/img/logo.png',
  website: '',
  slogan: '三工作台优点融合 · AI 驱动的一站式超级创作工作台',
  sloganEn: 'Three-workbench fusion · AI-powered all-in-one super creative workbench'
};
